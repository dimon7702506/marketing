...
class GetData
{
    ...
    public function search($sp_type, $text_search, $field_search, $query_type, $date_start, $date_end, $admin)
    {
        ...
        if ($sp_type == 'podr') {
            ...
            $fields_query_elem = 'cash_day.id, date_cash, apteka_id, error_check, unique_key, costs, count_k,
                ...
                turnover_0_k1, turnover_0_k2, turnover_0_k3,
                turnover_7_k1, turnover_7_k2, turnover_7_k3,
                turnover_20_k1, turnover_20_k2, turnover_20_k3,
                return_0_k1, return_0_k2, return_0_k3,
                return_7_k1, return_7_k2, return_7_k3,
                return_20_k1, return_20_k2, return_20_k3,
