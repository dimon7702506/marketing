    ...
    function save($element, $method)
    {
        ...
        if ($method == 'update') {
            $sql_update = "UPDATE names SET name = :name, morion_id = :morion_id, producer = :producer, barcode = :barcode, 
                    ...
                    fix_price = :fix_price, covid = :covid, covid_protokol = :covid_protokol, name_ukr = :name_ukr";
            $sql_end = " WHERE id = :id";
            ...
            $sql_update = "INSERT INTO names (name,   morion_id,  producer,  barcode,  tnved,  nac,  tax,  sum_com,  form_prod,  doza,  name_torg,  gran_price, marketing_id, MNN_id, modify,  amount_in_a_package,   project_dl, internet_price,  internet_sales,  fix_price,   covid, covid_protokol,  name_ukr)
                                      VALUES (:name, :morion_id, :producer, :barcode, :tnved, :nac, :tax, :sum_com, :form_prod, :doza, :name_torg, :gran_price, ($sql_m),     ($sql_mnn), '1', :amount_in_a_package, :project_dl, :internet_price, :internet_sales, :fix_price, :covid, :covid_protokol, :name_ukr)";
            $sql = $sql_update;
