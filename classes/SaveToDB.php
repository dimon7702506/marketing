...
class SaveToDB
{
    ...
    function save($element, $method)
    {
        ...
        if ($method == 'update') {
            ...
            $sql_update = "INSERT INTO names (name,   morion_id,  producer,  barcode,  tnved,  nac,  tax,  sum_com,  form_prod,  doza,  name_torg,  gran_price, marketing_id, MNN_id, modify,  amount_in_a_package,   project_dl, internet_price,  internet_sales)
                                      VALUES (:name, :morion_id, :producer, :barcode, :tnved, :nac, :tax, :sum_com, :form_prod, :doza, :name_torg, :gran_price, ($sql_m),     ($sql_mnn), '1', :amount_in_a_package, :project_dl, :internet_price, :internet_sales)";
            $sql = $sql_update;
