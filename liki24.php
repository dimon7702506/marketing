...
$ftp_server = 'liki24.com';
$ftp_user_name = 'ftpsmx58w';
$ftp_user_pass = '3D4d3S2y';
...
foreach ($results as $result){
    if ((!$result['liki24_id']) || (!$result['saldo_path'])) {
        continue;
    }
    if ($result['liki24_id'] == 0){
        continue;
    }
